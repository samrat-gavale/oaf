...
<form name="application_details" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"  onsubmit="return CheckPositionSchool(this);">
...
<input type="button" value="Next" onclick="parent.location= '../user/personal_info.php' ">
</div>

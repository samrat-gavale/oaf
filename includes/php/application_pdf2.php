...
$width_paragraph = 180;
   $query = "SELECT * FROM Other_Information WHERE User_ID = $user_id ";
    ...
    if ($row != NULL)
    {
	  ...
	  $uploaded = "";
	  $uploaded .=(($awards == 1)?" List of Awards uploaded ":"");
	  $uploaded .=(($extracurriculars == 1)?" List of Extracurriculars Activities uploaded ":"");
...
$pdf->Ln(6);
$pdf->MultiCell($width_paragraph, 4, $uploaded, 0, 'L', 0, 1, '', '', true);
$pdf->Ln(8);
     }
    else 

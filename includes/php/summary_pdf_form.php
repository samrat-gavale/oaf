...
$pdf->SetTitle('Summary Doocument - Online Application for Faculty Position');
$pdf->SetSubject('');
...
$uploaddir = '/var/www/uploads/oaf_uploads/'.$user_id.'/';
...
$pdf->setY($nextY);       //to be used for adjoining table
$pdf->Ln(5);
$currentY = $pdf->getY();
//Font for details
...
$width_nos = 27;
	$query = "SELECT Completed, In_Progress FROM Thesis_Guided WHERE User_ID = '" . $user_id. "'";
...
$pdf->Ln(5);
//$pdf->setY($nextY);
$pdf->writeHTMLCell(32, '', '', '', $thesis_guid_tbl, 0, 0, 0, true, 'L', true);

// write the second column
$pdf->writeHTMLCell(55, '', '', '', $spon_res_tbl, 0, 0, 0, true, 'L', true);

// write the third column
$pdf->writeHTMLCell(80, '', '', '', $publication_tbl, 0, 0, 0, true, 'L', true);
...
$pdf->Output('Summary Document.pdf', 'I');

<?php
	...
	$error_msg = "";
		  ...
		  $query = "SELECT Teaching_Experience FROM Forms_Submitted WHERE User_ID = '$user_id'";
	  ...
	  $query = "SELECT Sr_No, University_Organisation, Designation, Period_From, Period_To, Total_Period, Monthly_Salary, Nature_of_Duties FROM ".
	...
	$table1 =<<<EOD
		...
		<tr>
			<th scope="col"></th>
			<th scope="col">University / Organisation</th>
...
EOD;
		...
		for (; (list($key_sr_no, $sr_no) = each($sr_no_array)) && (list($key_university, $university) = each($university_array)) 
...
$table1 .=<<<EOD
		...
		<input type="button" class="delbutton" value="Delete Record" onclick='send_query("del_teaching_exp.php"); ' />
		<input type="button" class="delbutton" value="Add more records" onclick="parent.location= '../forms/teaching_exp.php' " />
			<br /><br />
...
<br />
<div>
<input type="button" value="Back" onclick="parent.location= 'acad_qualifications.php' ">
<input type="button" value="Next" onclick="parent.location= 'sponsored_research.php' ">
</div>
